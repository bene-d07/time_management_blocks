...
const STORAGE_KEY_DATA = 'weeklyPlanData_v6';
const STORAGE_KEY_NAME = 'weeklyPlanFileName_v6';
const STORAGE_KEY_TASKS = 'bigTasks_v6';
...
function restoreTasks() {
  try {
    ...
    bigTasks = Array.isArray(parsed)
      ? parsed.filter((task) => task && typeof task.title === 'string' && typeof task.date === 'string')
      : [];
